...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const commands: Command[] = [
    ...
    { id: 'toggle-terminal', label: 'Toggle Terminal', shortcut: 'Ctrl+`', description: 'Show/hide terminal panel', category: 'View', action: () => console.log('Toggle terminal') },
    { id: 'toggle-git', label: 'Toggle Git', shortcut: 'Ctrl+Shift+G', description: 'Show/hide git panel', category: 'View', action: () => console.log('Toggle git') },
    ...
    { id: 'new-terminal', label: 'New Terminal', shortcut: 'Ctrl+Shift+T', description: 'Create a new terminal tab', category: 'Terminal', action: () => console.log('New terminal') },
