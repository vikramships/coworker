...
interface AppState {
  ...
  setAiProfile: (profile: Partial<Profile>) => void;
}
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  userProfile: JSON.parse(localStorage.getItem('userProfile') || '{"name": "You"}'),
  aiProfile: JSON.parse(localStorage.getItem('aiProfile') || '{"name": "Kai"}'),
  ...
  setAiProfile: (profile) => {
    set((state) => {
      ...
      localStorage.setItem('aiProfile', JSON.stringify(next));
